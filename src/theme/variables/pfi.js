...
export default {
  ...
  DefaultFontSize: 17,
  checkboxBgColor: styles.colorPrimary,
  checkboxSize: 20,
  ...
  // Color
  brandPrimary: 'transparent'/*"##5577ff"*/,
  brandInfo: "#62B1F6",
  brandSuccess: "#5cb85c",
  brandDanger: "#d9534f",
  brandWarning: "#f0ad4e",
  ...
  // Progress Bar
  defaultProgressColor: styles.colorPrimary,
  inverseProgressColor: styles.colorPrimary,
  ...
  // Spinner
  defaultSpinnerColor:styles.colorPrimary,
